...
def Preselection(data : pd.DataFrame)-> pd.DataFrame:
    ...
    data = data[(data["PTJ1_0"] > 450)]

    """
    PT(J2) > 250 GeV 
    """

    data = data[(data["PTJ2_0"] > 250)]

    """
    |Eta(J1)| < 2 & |Eta(J2)| < 2 
    """

    data = data[(abs(data["eta1_0"]) < 2) & (abs(data["eta2_0"]) < 2)]

    """
    M(J1) > 50 GeV &  M(J2) > 50 GeV
    """

    data = data[(data["MJ1_0"] > 50) & (data["MJ2_0"] > 50)]
...
Xection_ttbar = 260.3554 #pb
Xection_ppbbbb = 0.4070 #pb
Xection_ppjjjb = 450.04 #pb
Xection_ppjjjj = 1106.2005 #pb
BRHhh = 0.8715
BRhbb = 0.3560
...
logging.info("sig_4_catal_eff : {} # of events: {}".format(sig_eff, sig_eff*Xection_ppHhh*BRHhh*BRhbb*BRhbb*Luminosity*1000))
logging.info("bkg_ttbar_4_catal_eff : {} # of events: {}".format(bkg_ttbar_eff, bkg_ttbar_eff*Xection_ttbar*Luminosity*1000))
logging.info("bkg_ppbbbb_4_catal_eff : {} # of events: {}".format(bkg_ppbbbb_eff, bkg_ppbbbb_eff*Xection_ppbbbb*Luminosity*1000))
logging.info("bkg_ppjjjb_4_catal_eff : {} # of events: {}".format(bkg_ppjjjb_eff, bkg_ppjjjb_eff*Xection_ppjjjb*Luminosity*1000))
logging.info("bkg_ppjjjj_4_catal_eff : {} # of events: {}".format(bkg_ppjjjj_eff, bkg_ppjjjj_eff*Xection_ppjjjj*Luminosity*1000))
logging.info("\n")
...
# %%
nset_simulation = 20
cut_threshold = 0.992#6587375264823
...
logging.info("Efficiency Before BDT")
logging.info("sig_eff : {} # of events: {}".format(sig_eff, sig_eff*Xection_ppHhh*BRHhh*BRhbb*BRhbb*Luminosity*1000))
logging.info("bkg_ttbar_eff : {} # of events: {}".format(bkg_ttbar_eff, bkg_ttbar_eff*Xection_ttbar*Luminosity*1000))
logging.info("bkg_ppbbbb_eff : {} # of events: {}".format(bkg_ppbbbb_eff, bkg_ppbbbb_eff*Xection_ppbbbb*Luminosity*1000))
logging.info("bkg_ppjjjb_eff : {} # of events: {}".format(bkg_ppjjjb_eff, bkg_ppjjjb_eff*Xection_ppjjjb*Luminosity*1000))
logging.info("bkg_ppjjjj_eff : {} # of events: {}".format(bkg_ppjjjj_eff, bkg_ppjjjj_eff*Xection_ppjjjj*Luminosity*1000))
logging.info("\n")
